// Functional Shadcn Button - SSR Compatible
...
export interface ShadcnButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
...
const variantStyles: Record<ShadcnButtonVariant, string> = {
...
const sizeStyles: Record<ShadcnButtonSize, string> = {
