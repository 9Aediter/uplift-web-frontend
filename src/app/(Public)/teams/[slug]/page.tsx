...
import { ArrowLeft, Mail, Github, Linkedin, Award, Globe, MapPin, Calendar, CheckCircle, ExternalLink, Download } from 'lucide-react';
...
export async function generateMetadata({ params }: TeamMemberPageProps) {
    ...
    const member = teamsData.team.find((m: any) => m.id === resolvedParams.slug);
...
const TeamMemberPage = async ({ params }: TeamMemberPageProps) => {
    ...
    const projects = [
        {
            title: locale === 'th' ? 'ระบบ ERP สำหรับโรงงาน' : 'Factory ERP System',
            description: locale === 'th' ? 'พัฒนาระบบ ERP ครบวงจรสำหรับโรงงานผลิต' : 'Developed comprehensive ERP system for manufacturing',
            tech: ['React', 'Node.js', 'PostgreSQL'],
            status: locale === 'th' ? 'เสร็จสิ้น' : 'Completed'
        },
        {
            title: locale === 'th' ? 'แอป POS สำหรับร้านอาหาร' : 'Restaurant POS App',
            description: locale === 'th' ? 'สร้างแอปพลิเคชัน POS สำหรับร้านอาหาร' : 'Built POS application for restaurant chains',
            tech: ['Flutter', 'Firebase', 'Dart'],
            status: locale === 'th' ? 'กำลังดำเนินการ' : 'In Progress'
        }
    ];
        ...
        <>
            ...
            <main className="relative w-full overflow-x-hidden">
                ...
                <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
                    <div className="max-w-6xl mx-auto px-4 py-4">
                        <Link href="/teams" className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">
                            ...
                            {locale === 'th' ? 'กลับไปหน้าทีม' : 'Back to Team'}
                        </Link>
                    </div>
                </div>
                            ...
                            <div className="lg:col-span-2">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-slate-600 dark:text-slate-400">
                                            {locale === 'th' ? 'ใบรับรอง' : 'Certifications'}
                                        </div>
                                    </div>
                                    <div>
                                        <div className="text-2xl font-bold text-slate-900 dark:text-white">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold mb-6 text-slate-900 dark:text-white">
                                    {locale === 'th' ? 'ทักษะเฉพาะด้าน' : 'Technical Skills'}
                                </h2>
                            ...
                            <div>
                                <h2 className="text-2xl font-bold mb-6 text-slate-900 dark:text-white">
                                    {locale === 'th' ? 'ความเชี่ยวชาญ' : 'Specialties'}
                                </h2>
                ...
                <section className="py-16 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-blue-950/50" id="certifications">
                    <div className="max-w-6xl mx-auto px-4">
                        <h2 className="text-3xl font-bold text-center mb-12 text-slate-900 dark:text-white">
                            {locale === 'th' ? 'ใบรับรองความสามารถ' : 'Professional Certifications'}
                        </h2>
                ...
                <section className="py-16 bg-white dark:bg-slate-900">
                    <div className="max-w-6xl mx-auto px-4">
                        <h2 className="text-3xl font-bold text-center mb-12 text-slate-900 dark:text-white">
                            {locale === 'th' ? 'โปรเจกต์ที่เกี่ยวข้อง' : 'Recent Projects'}
                        </h2>
                                ...
                                <div key={index} className="bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-800 dark:to-blue-950/50 p-8 rounded-xl border border-slate-200 dark:border-slate-700">
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                                            project.status === 'Completed' || project.status === 'เสร็จสิ้น' 
                ...
                <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600">
                    <div className="max-w-4xl mx-auto px-4 text-center text-white">
                        <h2 className="text-3xl font-bold mb-6">
                            {locale === 'th' ? `ต้องการติดต่อ ${member.name}?` : `Want to Connect with ${member.name}?`}
                        </h2>
