      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
            ...
            >
              ...
              <div className="flex space-x-4 pt-6">
                {socialLinks.map((social, index) => (
                  ...
                  >
                    <social.icon className="text-gray-300 group-hover:text-white transition-colors" />
                  </motion.a>
                ))}
              </div>
            </motion.div>
          ...
          >
            ...
            <div className="space-y-3">
              {services.map((service) => (
                ...
                >
                  <service.icon className="text-sm group-hover:text-blue-400" />
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-white font-bold text-lg mb-6">Projects</h3>
            <div className="space-y-3">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            {/* Terminal Command */}
            <div className="bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2 font-mono text-sm">
              <span className="text-green-400">$</span>
              <span className="text-blue-400 ml-2">npm install</span>
              <span className="text-purple-400 ml-1">@uplift/innovation</span>
            </div>
          </div>
        </motion.div>
      </div>
