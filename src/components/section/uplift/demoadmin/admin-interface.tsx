...
const MockSidebar = ({ collapsed }: { collapsed: boolean }) => {
  return (
    <div className={`${collapsed ? 'w-12 md:w-16' : 'w-48 md:w-64'} bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 flex flex-col border-r border-gray-700 transition-all duration-300 flex-shrink-0`}>
      
      {/* Header */}
      <div className={`${collapsed ? 'p-1 md:p-2' : 'p-2 md:p-4'} border-b border-gray-700 bg-gray-800/50`}>
        {collapsed ? (
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <span className="text-white font-semibold text-xs md:text-sm">Uplift Admin</span>
          </div>
        )}
      </div>
      ...
      <div className={`flex-1 ${collapsed ? 'p-1 md:p-2' : 'p-2 md:p-3'} space-y-1`}>
        ...
        {/* Users */}
        <div className={`flex items-center ${collapsed ? 'justify-center px-1 md:px-2' : 'space-x-2 md:space-x-3 px-2 md:px-3'} py-2 md:py-2.5 text-gray-400 hover:text-white hover:bg-gray-700/50 rounded-lg transition-all duration-200`}>
      ...
      {/* User Profile */}
      <div className={`${collapsed ? 'p-1 md:p-2' : 'p-2 md:p-3'} border-t border-gray-700 bg-gray-800/30`}>
      ...
      <div className="p-2 sm:p-4 md:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-4 sm:mb-6">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-3 sm:p-4 border border-blue-200">
            ...
            <div className="text-lg sm:text-xl font-bold text-blue-900 mb-1">$24,500</div>
            <div className="text-xs text-green-600">↗ +12.5%</div>
          </div>
          
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-3 sm:p-4 border border-green-200">
            <div className="text-xs text-green-600 mb-1 font-medium">Users</div>
            <div className="text-lg sm:text-xl font-bold text-green-900 mb-1">1,234</div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-3 sm:p-4 border border-purple-200">
            ...
            <div className="text-lg sm:text-xl font-bold text-purple-900 mb-1">456</div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-3 sm:p-4 border border-orange-200">
            ...
            <div className="text-lg sm:text-xl font-bold text-orange-900 mb-1">3.2%</div>
            <div className="text-xs text-green-600">↗ +1.1%</div>
          </div>
        </div>
        
        {/* Chart */}
        <div className="bg-white rounded-lg p-3 sm:p-4 md:p-6 mb-4 sm:mb-6 border border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6">
            <div className="mb-3 sm:mb-0">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1">Analytics Overview</h3>
              <p className="text-xs sm:text-sm text-gray-600">User growth and revenue trends</p>
            </div>
            <div className="flex space-x-1 sm:space-x-2">
              <button className="bg-blue-100 text-blue-700 px-2 sm:px-3 py-1 sm:py-1.5 rounded-md text-xs font-medium">7d</button>
              <button className="text-gray-500 hover:bg-gray-100 px-2 sm:px-3 py-1 sm:py-1.5 rounded-md text-xs">30d</button>
              <button className="text-gray-500 hover:bg-gray-100 px-2 sm:px-3 py-1 sm:py-1.5 rounded-md text-xs">90d</button>
            </div>
          </div>
          ...
          <div className="divide-y divide-gray-200">
            <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 flex flex-col sm:flex-row sm:justify-between sm:items-center">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-0">
                ...
                <span className="text-xs sm:text-sm text-gray-800">New user registration</span>
              </div>
            ...
            <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 flex flex-col sm:flex-row sm:justify-between sm:items-center">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-0">
                ...
                <span className="text-xs sm:text-sm text-gray-800">Payment processed - $150.00</span>
              </div>
            ...
            <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 flex flex-col sm:flex-row sm:justify-between sm:items-center">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-0">
                ...
                <span className="text-xs sm:text-sm text-gray-800">System backup completed</span>
              </div>
            ...
            <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 flex flex-col sm:flex-row sm:justify-between sm:items-center">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-0">
                ...
                <span className="text-xs sm:text-sm text-gray-800">Database optimization started</span>
              </div>
...
export const AdminInterface = () => {
  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden flex flex-col h-[400px] sm:h-[500px] md:h-[600px] shadow-lg">
      <MockHeader 
