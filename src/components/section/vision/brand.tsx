            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {brandPersonality.map((trait, index) => (
                        <div
                            key={index}
                            className="bg-gray-900/30 border border-gray-800 rounded-lg p-8 hover:bg-gray-900/50 transition-colors"
                        >
                            <h3 className="text-2xl font-bold mb-4 text-white">
                                {trait.title}
                            </h3>
                            <p className="text-xl text-gray-300">{trait.description}</p>
                        </div>
                    ))}
                </div>
                ...
                <div className="mt-20">
                    <div className="flex items-center mb-8">
                        <LayersIcon className="h-8 w-8 text-cyan-400 mr-4" />
