...
export async function generateMetadata() {
    ...
    const dataProtectionData = getDataProtectionData(locale);
                ...
                <section className="relative py-24 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50">
                    <div className="max-w-4xl mx-auto px-4 text-center">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                            {locale === 'th' ? 'การคุ้มครองข้อมูล' : 'Data Protection'}
                        </h1>
                ...
                <section className="py-16">
                    <div className="max-w-6xl mx-auto px-4">
                        ...
                        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="text-center p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                                ...
                                <h4 className="font-bold mb-2 text-slate-900 dark:text-white">
                                    {locale === 'th' ? 'มาตรฐาน ISO' : 'ISO Standards'}
                                </h4>
                                <p className="text-sm text-slate-600 dark:text-slate-300">
                                    {locale === 'th' ? 'ปฏิบัติตามมาตรฐานสากล' : 'Following international standards'}
                                </p>
                            </div>
                            ...
                            <div className="text-center p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                                ...
                                <h4 className="font-bold mb-2 text-slate-900 dark:text-white">
                                    {locale === 'th' ? 'กฎหมาย PDPA' : 'PDPA Compliance'}
                                </h4>
                                <p className="text-sm text-slate-600 dark:text-slate-300">
                                    {locale === 'th' ? 'ปฏิบัติตามกฎหมายไทย' : 'Compliant with Thai law'}
                                </p>
                            </div>
                            ...
                            <div className="text-center p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                                ...
                                <h4 className="font-bold mb-2 text-slate-900 dark:text-white">
                                    {locale === 'th' ? 'การตรวจสอบ' : 'Regular Audits'}
                                </h4>
                                <p className="text-sm text-slate-600 dark:text-slate-300">
                                    {locale === 'th' ? 'ตรวจสอบความปลอดภัยสม่ำเสมอ' : 'Regular security assessments'}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-16 text-center p-8 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50 rounded-xl border border-blue-200 dark:border-blue-800">
                            <h3 className="text-xl font-bold mb-4 text-slate-900 dark:text-white">
                                {locale === 'th' ? 'รายงานเหตุการณ์ความปลอดภัย' : 'Report Security Issues'}
                            </h3>
